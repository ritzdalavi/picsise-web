            ...
            <section data-aos="fade-up">
                ...
                <div className="p-16" data-aos="fade-in" data-aos-delay="600">
                    ...
                    <div className="mt-12 text-center">
                        <h2 className="text-2xl text-gray-700 font-semibold">Clients Coming Soon...</h2>
                        <p className="text-lg text-gray-500 mt-2">Stay tuned as we continue to expand our partnerships!</p>
                    </div>
                </div>
            </section>
        </div>
