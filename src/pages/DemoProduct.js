...
const DemoProduct = () => {
    useDocTitle('MLD | Molad e Konsult - Request a Demo');
                ...
                <div className="container mx-auto my-8 px-4 lg:px-20" data-aos="zoom-in">
                    <form onSubmit={sendEmail} id="demoProductForm">
                        <div className="w-full bg-white p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
                            <div className="flex">
                                <h1 className="font-bold text-center lg:text-left text-blue-900 uppercase text-4xl">contact</h1>
                            </div>
                        ...
                        <div className="flex flex-col text-white">
                            ...
                            <div className="flex my-4 w-2/3 lg:w-1/2">
                                <div className="flex flex-col">
                                    ...
                                    <p className="text-gray-400">Tel: +91 87670 71282</p>
                                    <h2 className="text-2xl mt-5">Send an E-mail</h2>
                                    <p className="text-gray-400">picsisetechnologies@gmail.com</p>
                                </div>
                            </div>
                        </div>
                    </div>
